...
window.addEventListener('load', () => {
    ...
    refreshMonthlyProfitIncExpForm();


});


const refreshMonthlyProfitIncExpForm = () => {
    ...
    let maxStartDate = currentDateForMaxSDate.setDate(currentDateForMaxSDate.getDate() - 31);
...
const dailyprofitexpincome = () => {
    ...
    if (error == '') {
        const dataListReport = ajaxGetRequestMapping("/profitlossreportbymonthname/" + reportdailyprofitexpincome.sdate + "/" + reportdailyprofitexpincome.edate);
